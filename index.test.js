...
const { selectionSort, insertionSortPlus, mergeSort, mergeSortBU, quickSort, quickSortRepetition, quickSort3Ways, BinaryHeap, heapSort } = require('./index')
...
// const hello = new BinaryHeap()

// for (let index = 0; index < 100; index++) {
//   const randKey = parseInt(Math.random() * 1000)
//   hello.insert(randKey)
// }
