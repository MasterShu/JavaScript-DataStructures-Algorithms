...
const { selectionSort, insertionSortPlus, mergeSort, mergeSortBU, quickSort, quickSortRepetition, quickSort3Ways, BinaryHeap, heapSort, IndexHeap, bubbleSort } = require('./index')
...
testSort('bubbleSort', bubbleSort, arr, numOfTimes)
